          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <form class="d-flex" method="post" action="#">
                <input class="form-control me-2" type="search" name="searchInput" placeholder="Buscar Producto" aria-label="Search" required>
           ...
           $dbname = "cross_army_fitness";
            ...
            if ($conn->connect_error) {
              ...
              if(isset($_POST['searchInput'])) {
                ...
                $sql = "SELECT id, nombre, marca, cantidad, imagen, precio FROM productos WHERE ESTATUS = 'activo' AND (nombre LIKE '%$searchInput%' OR marca LIKE '%$searchInput%' OR precio LIKE '%$searchInput%')";
            } else {
                // Si no se envió el formulario de búsqueda, obtener todos los productos con estatus activo
                $sql = "SELECT id, nombre, marca, cantidad, imagen, precio FROM productos WHERE ESTATUS = 'activo'";
            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        imagenes.forEach(function(imagen) {
            imagen.addEventListener('click', function() {
                ...
                window.location.href = 'ver_productos_grande.php?id=' + id;
            });
        });
    });
