...
<h1 class="responsive-text" style="-webkit-text-stroke: 2px black; color: transparent; text-shadow: 0px 4px 4px #282828;">Mensajes Recibidos</h1><hr>

<a href="notificaciones2.php" class="btn btn-success"><i class="fas fa-paper-plane"></i> Enviados</a><br><br>

<div id="mensajes_recibidos">
    <?php
    // Conexión a la base de datos
    $conexion = mysqli_connect
("localhost", "root", "", "cross_army_fitness");
