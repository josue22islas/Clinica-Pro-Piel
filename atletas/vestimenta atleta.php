...
<a class="navbar-brand" style="color:rgb(247, 199, 26); background-color: rgb(22, 53, 175); border-radius: 7px; padding: 0 10px;" href="#">Cross Army Fitness</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="vestimenta atleta.php"><i class="fas fa-cart-plus" style="color: #ffffff;"></i></i>/Productos</a>
            </li>
            <li class="nav-item">
           ...
           $dbname = "cross_army_fitness";
            ...
            if ($conn->connect_error) {
              ...
              if(isset($_POST['searchInput'])) {
                ...
                $sql = "SELECT id, nombre, marca, cantidad, talla, imagen, precio FROM productos_vestimenta WHERE ESTATUS = 'activo' AND (nombre LIKE '%$searchInput%' OR marca LIKE '%$searchInput%' OR precio LIKE '%$searchInput%')";
            } else {
                // Si no se envió el formulario de búsqueda, obtener todos los productos con estatus activo
                $sql = "SELECT id, nombre, marca, cantidad, talla, imagen, precio FROM productos_vestimenta WHERE ESTATUS = 'activo'";
            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        imagenes.forEach(function(imagen) {
            imagen.addEventListener('click', function() {
                ...
                window.location.href = 'ver_vestimenta_grande.php?id=' + id;
            });
        });
    });
