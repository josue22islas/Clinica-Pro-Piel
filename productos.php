...
/*.producto-info h2:hover { 
    white-space: normal;
    overflow: visible;            activamos para dar estilo hover si es que lo requerimos en la informacion del producto
    z-index: 9999;
    position: absolute;
    ...
    border-radius: 5px;
} <img src="images/heading_iconw.png" alt="#"/> 
*/
...
<option value="" disabled selected style="display:none;">Selecciona una opción</option>
        ...
        <div class="row">
           ...
           require_once("conex_db/conex_db.php");
            ...
            $sql = "SELECT id, nombre, marca, cantidad, imagen, precio FROM productos WHERE ESTATUS = 'activo'"; // Agregamos el campo "precio" a la consulta
