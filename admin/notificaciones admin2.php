...
<h2 class="text-center responsive-text" style="-webkit-text-stroke: 2px black; color: transparent; text-shadow: 0px 4px 4px #282828;">Mensajes Enviados</h2><hr>
<a href="notificaciones admin.php" class="btn btn-success"><i class="fas fa-envelope-open"></i>  Recibidos</a>
<br><br>
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<i class='fas fa-paper-plane' style='color: #1869f7;'></i> Para: " . $row['receptor_nombre'] . "<br><hr>";
