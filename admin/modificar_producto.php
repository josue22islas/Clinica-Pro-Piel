...
$dbname = "u990524785_cross_army";
  ...
  $sql = "SELECT id, nombre, estatus, precio, marca, cantidad, imagen, fecha_registro FROM productos WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "UPDATE productos SET nombre=?, precio=?, marca=?, cantidad=?, fecha_registro=? WHERE id=?";
  $stmt = $conn->prepare($sql);
...
?>
   <button class="btn btn-primary" type="submit">Actualizar</button>
            ...
            <a href="productos admin.php"><button class="btn btn-success" type="button">Regresar</button></a>
