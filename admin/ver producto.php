...
<div class="container col-sm-10" style="background-color: rgba(255, 255, 255, 0.9);  border-radius:10px;">
 <div class="container mt-5"><br><br>
        <div class="row">
          ...
          echo "<a style='text-decoration:none;' class='text-white' href='modificar_producto.php?id=".$row['id']."'>
          <button class='btn btn-primary' type='button'>Editar
           </a></button>";

      echo "<a style='text-decoration:none;' class='text-white' href='productos admin.php''>
