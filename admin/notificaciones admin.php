...
<h2 class="text-center responsive-text" style="-webkit-text-stroke: 2px black; color: transparent; text-shadow: 0px 4px 4px #282828;">Mensajes Recibidos</h2><hr>
<!-- Enlace "Mensajes Enviados" -->
<a href="notificaciones admin2.php" class="btn btn-success"><i class="fas fa-paper-plane"></i> Enviados</a>
<a href="reporte_comentarios.php" class="btn btn-info my-2"><i class="fas fa-mail-bulk"></i> Buzon</a>
<a href="reporte_contactenos.php" class="btn btn-secondary"><i class="fas fa-envelope-square"></i> Contáctenos</a><br><br>
...
<div id="mensajes_recibidos">
    ...
    if ($hayMensajes) {
        while ($row = mysqli_fetch_assoc($result_recibidos)) {
            ...
            echo "<i class='fas fa-user-circle' style='color: #1869f7;'></i> De: " . $row['emisor_nombre'] . "<br><hr>";
            ...
            echo "<a href='borrar_mensaje.php?id=" . $row['id'] . "'style='color:red;'><i class='fas fa-trash-alt'> </i> Eliminar</a>";
            echo "</div><br>";
        }
    } else {
