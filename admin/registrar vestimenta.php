    ...
    if (!empty($_FILES["imagen"]["tmp_name"]) && file_exists($_FILES["imagen"]["tmp_name"])) {
        ...
        if ($_FILES["imagen"]["size"] > $maxSize) {
            ...
            if (in_array(strtolower($extension), $extensionesPermitidas)) {
                ...
                $sql = "INSERT INTO productos_vestimenta (nombre, marca, precio, imagen, fecha_registro, cantidad, talla) VALUES (?, ?, ?, ?, ?, ?, ?)";
                $stmt = $conn->prepare($sql);
                $stmt->bind_param("ssdssss", $nombre, $marca, $precio, $imagen, $fecha_registro, $cantidad, $talla);
      ...
      <div class="container">
        ...
        <button class="btn btn-dark" onclick="redireccionar()">Ir a la categoría</button>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="talla" name="talla" placeholder="Ingrese talla" class="form-control" required>
                    </div>
                    ...
                    <a class="btn btn-danger" href="productos admin vestimenta.php">Cancelar</a>
                </form>
