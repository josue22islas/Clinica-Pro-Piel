...
<a class="navbar-brand" style="color:rgb(247, 199, 26); background-color: rgb(22, 53, 175); border-radius: 7px; padding: 0 10px;" href="#">Cross Army Fitness</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="reporte de membresias.php"><i class="fas fa-star" style="color: #ffffff;"></i>/Membresías</a>
              </li>
              <li class="nav-item">
    ...
    <?php endif; ?>
            ...
            <div class="datos-perfil"><br>
                ...
                <h4 class="titulo-usuario">¡Administrador: <?php echo $userInformation['nombre']; ?>!</h4>
                 <p class="bio-usuario"><b><i class="fas fa-envelope fa-sm"></i>  <?php echo $userInformation['email']; ?></b></p>
                <ul class="lista-perfil">
                    <li><a style="color:blue;" href="img_perfil_admin.php"><i class="fas fa-camera"></i><b> Cambiar foto de perfil</b></li></a>
        ...
        <div class="menu-perfil">
            ...
            <li class="my-2"><a id="abrirModal2" style="background-color: #209ff4;" href="#" title=""><i class="fas fa-bell"></i> / Notificaciones</a></li>
               ...
               <li class="my-2"><a style="background-color: #209ff4;" href="galeria de admin.php" title=""><i class="fas fa-camera"></i> / Galería</a></li>
            </ul>
        </div>
    </div>
</section>
                    ...
                    <?php endif; ?>
                     ...
                     <div  class="alert alert-primary">
                        ...
                        <div class="d-flex justify-content-center mb-2">
                            <p style="text-align:justify;">Bienvenido administrador <?php echo $userInformation['nombre']; ?> nos complace tenerlo de vuelta en el sistema!</p>
                        </div>
                      </div>
                    </div>
                </div>
               ...
               <div class="row">
                     ...
                     <p class="mb-0">Nombre:</p>
                          ...
                          <div class="col-sm-9">
                            <div class="input-group">
                               <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Escribir tu email" value="<?php echo $userInformation['nombre'] ?>">
                  ...
                  <div class="col-sm-3">
                     <p class="mb-0">Ciudad:</p>
                            ...
                            <div class="col-sm-9">
                            <div class="input-group">
                             <input type="text" class="form-control" name="ciudad" id="ciudad" placeholder="Escribir tu ciudad" value="<?php echo $userInformation['ciudad']?>" required >
                             <div class="input-group-append">
                                   <span class="input-group-text"> <i class="fas fa-edit"></i></span>
                                </div>
                              </div>
                     ...
                     <p class="mb-0">Sexo:</p>
                            ...
                            <div class="input-group">
                              <select class="form-control" name="sexo" id="sexo">
                               <option  <?php echo ($userInformation['sexo'] == '') ? 'selected' : ''; ?> disabled>Seleccione Sexo...</option>
                     ...
                     <p class="mb-0">Categoría:</p>
                            ...
                            <div class="input-group">
                              <select class="form-control" name="categoria" id="categoria">
                               <option  <?php echo ($userInformation['categoria'] == '') ? 'selected' : ''; ?> disabled>Selecciona una Categoria...</option>
                               <option value="Principiante" <?php echo ($userInformation['categoria'] == 'Principiante') ? 'selected' : ''; ?>>Principiante</option>
                               <option value="Intermedio" <?php echo ($userInformation['categoria'] == 'Intermedio') ? 'selected' : ''; ?>>Intermedio</option>
                               <option value="Avanzado" <?php echo ($userInformation['categoria'] == 'Avanzado') ? 'selected' : ''; ?>>Avanzado</option>
                              </select>
                              <div class="input-group-append">
                                   <span class="input-group-text"> <i class="fas fa-edit"></i></span>
                                </div>
                        ...
                        <div>
                            ...
                            <a  href="perfil admin.php"><button class="btn btn-success my-2" type="button">Regresar</button></a>
