...
<a class="navbar-brand" style="color:rgb(247, 199, 26); background-color: rgb(22, 53, 175); border-radius: 7px; padding: 0 10px;" href="#">Cross Army Fitness</a>
     ...
     <div class="row">
         <div class="col-12 text-center"> <br><br>
             <h1 style="font-size: 3rem;"><b>Mi foto de Perfil</h1><hr>
         </div>
     </div>
...
<br>
                 ...
                 <button type="button" class="btn btn-danger" onclick="window.location.href='perfil admin.php'">Cancelar Cambios</button>
