...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM productos_vestimenta WHERE id = $id";
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="row">
                            <div class="col-sm-10">
                            <h2 class="mb-0 text-muted">Información del producto</h2>
                        </div>
                      </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['talla']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['talla'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['estatus']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['estatus'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
          ...
          echo "<a style='text-decoration:none;' class='text-white' href='modificar_producto V.php?id=".$row['id']."'>
          <button class='btn btn-primary' type='button'>Editar
           </a></button>";

      echo "<a style='text-decoration:none;' class='text-white' href='productos admin vestimenta.php''>
