...
<h2 class="text-center responsive-text" style="-webkit-text-stroke: 2px black; color: transparent; text-shadow: 0px 4px 4px #282828;">Buzon de Contáctenos</h2><hr>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
         ...
         echo "<i class='fas fa-user-circle' style='color: #1869f7;'></i> De: " . $row["nombre_completo"] . "<br>";
         echo "<i class='fas fa-at' style='color: #1869f7;'></i> " . $row["email"] . "<br>";
         echo "<i class='fas fa-phone' style='color: #1869f7;' ></i> " . $row["telefono"] . "<br><hr>";
        ...
        echo "<a href='borrar_mensaje_contactenos.php?id=" . $row['id'] . "'style='color:red;'><i class='fas fa-trash-alt'> </i> Eliminar</a>";
        echo "</div>";
    }
} else {
  echo "<div class='container m-0 row justify-content-center'>";
  echo "<div class='alert alert-secondary col-12 text-center'>No se encontraron comentarios.</div>";
  echo "</div>"; 
