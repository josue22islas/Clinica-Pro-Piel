        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card mb-4">
                    ...
                    <?php if (!empty($row['imagen'])) : ?>
                        <img src='data:image/jpeg;base64,<?= base64_encode($row['imagen']) ?>' alt='Imagen de Perfil' width='150' height='150'>
                    <?php else : ?>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="row">
                            <div class="col-sm-10">
                            <h2 class="mb-0 text-muted">Información personal</h2>
                        </div>
                      </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['email']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['email'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['ciudad']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['ciudad'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['codigo_postal']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['codigo_postal'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['telefono']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['telefono'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0"><?php echo $row['estatus']; ?></p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['edad']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['edad'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <?php echo empty($row['sexo']) ? '<p class="text-muted mb-0">Ingrese información <i class="fas fa-edit"></i></p>' : '<p class="text-muted mb-0">' . $row['sexo'] . '</p>'; ?>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0"><?php echo $row['categoria']; ?></p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                ...
                echo "<a style='text-decoration:none;' class='text-white' href='editar atleta.php?id=".$row['id']."'>
                    <button class='btn btn-primary' type='button'>Editar
                     </button></a>";

                echo "<a style='text-decoration:none;' class='text-white' href='reporte de atletas.php''>
                    <button class='btn btn-success' type='button'>Regresar
                     </button></a>";

                echo "<div style='text-align:center;'><a  href='restablecer email y password.php?id=".$row['id']."'>
                      Restablecer correo y contraseña
                    </a></div>";  
?>
