...
<div class="disenio">
        <h1 class="text-center responsive-text" style="-webkit-text-stroke: 2px black; color: transparent; text-shadow: 0px 4px 4px #282828;">Reporte de Atletas</h1><hr>
        <h3 class="col-10">Lista de atletas</h3>
        <br>

        <div class="col-sm-6">
        <a id="abrirModal45" href="###" class="text-white" style="text-decoration:none;">
            <button class="btn btn-primary" type="button">Registrar Atleta
      </button></a>
        
        <a class="text-white" style="text-decoration:none;" href="atletas_inactivos.php">
            <button class="btn btn-danger my-2" type="button">Atletas Eliminados
       </button> </a><br><br>
        </div>
        ...
        <table class="table table-bordered bg-white table-hover" border="1" cellspacing="2" cellpading="3">
            ...
            <tbody>
                ...
                $sql_contar_activos = "SELECT COUNT(*) as total_activos FROM usuarios WHERE ESTATUS = 'activo'";
                        ...
                        echo "<tr>
                         <td>".$row['nombre']."</td> 
                                ...
                                if ($row["rol"] === "usuario") {
                                   ...
                                   echo "<a href='ver atleta.php?id=".$row['id']."'>
                                            <button title='Ver perfil' class='btn btn-info' type='button'><i class='fas fa-eye text-white'></i>
                                         </button></a>";
                                    echo "<a href='editar atleta.php?id=".$row['id']."' style='text-decoration:none;'>
                                            <button title='Editar' class='btn btn-success' type='button'><li class='fas fa-edit text-white'>
                                            </button></a>";
                                    echo "<a href='cambiar_estatus_inactivo.php?id=".$row['id']."' style='text-decoration:none;'>
                                            <button title='Eliminar' class='btn btn-danger cambiar-estado' data-id='" . $row['id'] . "'  type='button'><i class='fas fa-trash-alt text-white'></i>
                                            </button></a>";



                                } else {
                                  echo "<i class='fas fa-lock'></i> Administrador";
                                }
                            ...
                            echo "<tr>
                                <td colspan='11'><center>Datos no disponibles/Base de datos vacía</center></td>
                                </tr>";
                        }
    ...
    <p>Total de atletas activos: <?php echo $total_activos; ?></p>
</div><br><br><br><br>
    </div>
                                </div> 
                              </div>
...
<!-- Modal de confirmación -->                       <!----data-backdrop="static" data-keyboard="false" para bloquear hasta cerrar el modal solo agregamos estas lienas de codigo--->
  ...
  <div class="modal-dialog custom-modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ¿Estás seguro de que deseas cambiar el estado a inactivo?
      </div>
...
<div id="miModal" class="modal" style="display:none;">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Cuerpo del modal -->
      <div class="modal-body">
      <h3 class="alert alert-success text-center"><i class="fas fa-check-circle fa-2x"></i><br>   Los datos han sido actualizados correctamente.<br><br></h3>
...
<!-- Aquí colocamos el modal de la actualizacion  -->
<div id="miModalpass" class="modal" style="display:none;">
  <div class="modal-dialog">
    <div class="modal-content">
      <!-- Encabezado del modal -->
      <div class="modal-header">
      ...
      <!-- Cuerpo del modal -->
      <div class="modal-body">
      <h3 class="alert alert-success text-center"><i class="fas fa-check-circle fa-2x"></i><br>   La contraseña ha sido actualizada correctamente.<br><br></h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    botonesCambiarEstado.forEach(function(boton) {
        boton.addEventListener('click', function(event) {
            ...
            confirmarCambio.setAttribute('href', 'cambiar_estatus_inactivo.php?id=' + id);
...
window.onload = function() {
  ...
  if (params.has('error4') && params.get('error4') === 'error_nombre') {
    ...
    $("#miModal").modal("show");
     ...
     // Mostrar el modal si el parámetro 'actualizado' es 'true'
     if (params.has('actualizado_password') && params.get('actualizado_password') === 'true') {
    $("#miModalpass").modal("show");
  }
