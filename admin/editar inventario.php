...
$dbname = "u990524785_cross_army";
  ...
  $sql = "SELECT id, nombre, marca, cantidad, peso, estado_del_equipo, precio, imagen, fecha_registro FROM inventario WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "UPDATE inventario SET nombre=?, marca=?, cantidad=?, peso=?, estado_del_equipo=?, precio=?, fecha_registro=? WHERE id=?";
  $stmt = $conn->prepare($sql);
  $stmt->bind_param("sssssssi", $nombre, $marca, $cantidad, $peso, $estado_del_equipo, $precio, $fecha_registro, $id);
  $stmt->execute();
  $stmt->close();
  $conn->close();
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <select class="form-control" name="cantidad" id="cantidad">
                               <option><?php echo $cantidad; ?></option>
                               ...
                               <option value="7 Unidades" >7 Unidades</option>
                               <option value="8 Unidades" >8 Unidades</option>
                               <option value="9 Unidades" >9 Unidades</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                            <div class="input-group">
                            <input type="number" class="form-control" id="peso" name="peso" value="<?php echo $peso; ?>" required>
                            <div class="input-group-append">
                                   <span class="input-group-text"> <i class="fas fa-edit"></i></span>
                                </div> 
                              </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0">Estado del equipo:</p>
                            </div>
                            <div class="col-sm-9">
                            <div class="input-group">
                            <select class="form-control" name="estado_del_equipo" id="estado_del_equipo">
                               <option><?php echo $estado_del_equipo; ?></option>
...
?>
   <button class="btn btn-primary" type="submit">Actualizar</button>
            ...
            <a href="Inventario crosfit.php"><button class="btn btn-success" type="button">Regresar</button></a>
