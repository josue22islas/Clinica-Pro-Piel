...
$sql_contar_activos = "SELECT COUNT(*) as total_activos FROM productos_vestimenta WHERE ESTATUS = 'inactivo'";
...
if(isset($_POST['searchInput'])) {
    $searchInput = $_POST['searchInput'];
       ...
       $sql = "SELECT id, nombre, marca, cantidad, talla, fecha_registro, imagen, precio FROM productos_vestimenta WHERE ESTATUS = 'inactivo' AND (nombre LIKE '%$searchInput%' OR marca LIKE '%$searchInput%' OR precio LIKE '%$searchInput%')";
} else {
      // Si no se envió el formulario de búsqueda, obtener todos los productos de la consulta...
    $sql = "SELECT id, nombre, marca, cantidad, talla, precio, imagen, fecha_registro FROM productos_vestimenta WHERE ESTATUS = 'inactivo'";
}
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<a href="cambiar_activo_vestimenta.php?id=' . $id . '"class="btn btn-primary activar-estado" data-id="' . $row['id'] . '">Activar</a> ';
  ...
  <script>
    ...
    botonesCambiarEstado.forEach(function(boton) {
        boton.addEventListener('click', function(event) {
            ...
            confirmarCambio.setAttribute('href', 'eliminar_vestimenta.php?id=' + id);
   ...
   document.addEventListener('DOMContentLoaded', function() {
    ...
    botonesCambiarEstado.forEach(function(boton) {
        boton.addEventListener('click', function(event) {
            ...
            confirmarCambio.setAttribute('href', 'cambiar_activo_vestimenta.php?id=' + id);
